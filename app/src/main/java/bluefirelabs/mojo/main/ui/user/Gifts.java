...
public class Gifts extends AppCompatActivity
    ...
    public void firebaseTask(final MyCallback myCallback) {
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference("uid/"+UID+"/gifts");
...
///////////////////////////
        ...
        MyCallback myCallback = new MyCallback() {
            ...
            public void callbackCall(String restaurant) {
                ...
                mLinearLayoutManager = new LinearLayoutManager(Gifts.this);
                mLinearLayoutManager.setStackFromEnd(true);

                mFirebaseDatabaseReference = FirebaseDatabase.getInstance().getReference();
                mFirebaseAdapter = new FirebaseRecyclerAdapter<Vendor_Order_List, Gifts.RecyclerViewHolder>(
                        Vendor_Order_List.class,
                        R.layout.vendor_card_layout,
                        Gifts.RecyclerViewHolder.class,
                        mFirebaseDatabaseReference.child(RESTAURANT)
                ) {

                    @Override
                    protected void populateViewHolder(final Gifts.RecyclerViewHolder viewHolder, Vendor_Order_List model, int position) {
                        viewHolder.itemTitle.setText("Order ID: " + model.getOrderid());
                        //viewHolder.itemTitle.setText("Order: " + model.getDescription());
                        //viewHolder.itemName.setText(model.getName());
                        viewHolder.itemName.setText(model.getDescription());

                        final DatabaseReference reference1 = FirebaseDatabase.getInstance().getReference(RESTAURANT);
                            ...
                            public void onClick(View v) {
                                reference1.orderByChild("orderid").equalTo(viewHolder.itemTitle.getText().toString().replace("Order ID: ", "")).addChildEventListener(new ChildEventListener() {
                                    ...
                                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                                        ...
                                        hopperUpdates.put("result", "asking");
                        ...
                        /* viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent editCheckoutintent = new Intent(Gifts.this, Vendor_Checkout.class);
    ...
    private class GetAddress extends AsyncTask<String,Void,String> {
        ...
        ProgressDialog dialog = new ProgressDialog(Gifts.this);
